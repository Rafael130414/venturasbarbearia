...
export default function Barbers() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setShowModal(false);
        setFormData({ name: '', phone: '', lunch_start: '12:00', lunch_end: '13:00' });
        loadBarbers();
    };
            ...
            <div className="grid gap-6 sm:gap-10 md:grid-cols-2 lg:grid-cols-3">
                {barbers.map((barber) => (
                    <div key={barber.id} className="monolith-card p-6 sm:p-10 group relative overflow-hidden">
                        {/* Massive BG Name */}
                        <div className="absolute -bottom-4 -left-4 text-[40px] sm:text-[60px] font-black text-slate-900 opacity-[0.03] select-none pointer-events-none tracking-tighter uppercase whitespace-nowrap">
                            {barber.name}
                        </div>
                        ...
                        <div className="flex flex-col items-center relative z-10 text-center">
                            ...
                            <div className="w-24 h-24 bg-[#020617] text-white flex items-center justify-center rotate-3 shadow-[6px_6px_0px_#F59E0B] mb-8 group-hover:-rotate-3 transition-transform duration-500">
